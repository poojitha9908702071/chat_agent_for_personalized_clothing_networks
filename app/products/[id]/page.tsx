          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {colors.map((color) => (
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2.5 rounded-md border-2 transition-all ${
                    ...
                    >
                      <div
                        className={`w-5 h-5 rounded-full border-2 ${
                          color.name === "White" ? "border-gray-400" : "border-gray-300"
                        }`}
                        style={{ backgroundColor: color.hex }}
                      />
                      <span className="font-semibold text-sm text-gray-900">{color.name}</span>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-pink-200 bg-pink-50 rounded-lg p-4 space-y-2 border border-pink-200">
                ...
                <p className="flex items-center gap-2 text-gray-700 text-sm">
                  <span className="text-green-600">✓</span> Easy 30-day returns
                </p>
                <p className="flex items-center gap-2 text-gray-700 text-sm">
