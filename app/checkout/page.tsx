...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = () => {
    ...
    try {
      ...
      existingOrders.push({ id: orderId, date: new Date().toISOString(), total: totalAmount });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-white p-4 sm:p-8">
